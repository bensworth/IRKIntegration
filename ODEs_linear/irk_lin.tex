...
%
\begin{align*}
\mathbf{k} &:= \textnormal{diag}(\det(\mathcal{M}_s)^{-1})
...
numerator to denominator terms in \eqref{eq:khat} is $\widehat{K} := \tfrac{\gamma_*^2}{\eta^2}$.
...
again $\widehat{K} := \tfrac{\gamma_*^2}{\eta^2}$. Altogether, this yields
%
\begin{align*}
