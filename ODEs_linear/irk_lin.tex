...
\begin{remark}[Implementation and complexity]
...
\begin{table}[!ht]
  ...
  \hline
Stages & 2 & \multicolumn{2}{c}{3} & \multicolumn{2}{|c}{4} & \multicolumn{3}{|c|}{5} \\
\hline
\mc{} & \mc{$\lambda_1$} & \mc{$\lambda_1^*$} & \mc{$\lambda_2$} & \mc{$\lambda_1$} & \mc{$\lambda_2$} & \mc{$\lambda_1^*$} & \mc{$\lambda_2$} & \mc{$\lambda_3$} \\
\hline
...
Lobatto IIIC  & 2.24 & 1.00 & 3.37 & 4.37 & 1.19 & 1.00 & 5.27 & 1.52 \\\hline
  ...
  with 2--5 stages. Each column $\lambda_i$ within a given set of stages corresponds
  to a conjugate pair of eigenvalues of $A_0^{-1}$. For odd numbers of stages,
  one eigenvalue is real, denoted by $\lambda_1^*$.}\label{tab:cond}
\end{table}
...
% ------------------------------------------------------------------------------------- %
\subsubsection{High-order and advection-dominated}\label{sec:numerics:dg:adv}
