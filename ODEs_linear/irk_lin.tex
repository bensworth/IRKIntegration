...
Department of Energy under contract DE-AC52-07NA27344 and Lawrence Livermore National Laboratory under  contract B639443.}}
...
integration using roughly half preconditioning iterations
...
Since this corresponds to using a variable preconditioner at each iteration, a flexible Krylov method may have be used for the outer iteration, although in practice good convergence is often still observed using the standard CG method \cite{Notay2000}.
