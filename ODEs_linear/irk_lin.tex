...
Lobatto IIIC  & 2.24 & 1.00 & 3.37 & 4.37 & 1.19 & 1.00 & 5.27 & 1.52 \\\hline
  ...
  one eigenvalue is real, corresponding to the column with conditioning 1.
  {\color{red} WP: Maybe add headers to the table to indicate that the columns
  correspond to conjugate pairs of eigenvalues.}}\label{tab:cond}
\end{table}
