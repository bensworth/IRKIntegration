...
public:
    ...
    inline void AddExplicitGradientsMult(double c1, const Vector &weights1, 
        double c2, const Vector &weights2, const Vector &x, Vector &y1,
        Vector &y2) const;
};
...
public:
    /// 1x1 block
    JacDiagBlockTriPrec(const JacDiagBlock &BlockOper_, bool identity_=false);
...
private:
    ...
    /** Solve \tilde{J}*y = z via block backward substitution, where
        ...
        solve */
    inline void BlockBackwardSubstitution(BlockVector &z_block,
