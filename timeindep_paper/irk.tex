...
method of choice must store two stages instead of one for each vector in the
Krylov space. On the bright side, the method based on a real Schur decomposition
does give insight into a preconditioning for the fully nonlinear and
time-dependent setting, which is discussed in the next section. 
