...
% ------------------------------------------------------------------------------------- %
\subsection{High-order \& advection-dominated}\label{sec:numerics_lin:dg:adv}
...
permitted through the new preconditioning still offers the opportuntity
...
% ------------------------------------------------------------------------------------- %
\subsection{Diffusive problems and inner Krylov}\label{sec:numerics_lin:dg:diff}
