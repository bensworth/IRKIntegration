...
parallel solution of fully implicit Runge-Kutta (IRK) schemes in the integration
of numerical PDEs, focusing on nonlinearities and differential algebraic
equations (DAEs). This framework also naturally applies to discontinuous
...
Several new methods of linearizing the nonlinear IRK equations are developed,
...
set of block $2\times 2$ systems, and, under quite general assumptions on the
