...
\tcb{Come to think, suppose $\gamma = \eta$. This cancels the $\mathcal{L}$ 
perturbation term in the numerator above and
leaves an identity perturbation. But, if $(I - \tfrac{1}{\gamma}\mathcal{L})$ has
purely imaginary eigenvalues, $(I - \tfrac{1}{\gamma}\mathcal{L})^{2}$ has
negative eigenvalues, and we can construct one of magnitude
$\tfrac{\beta^2 + (\gamma-\eta)^2}{\gamma^2}$, which makes the 
numerator zero.}
