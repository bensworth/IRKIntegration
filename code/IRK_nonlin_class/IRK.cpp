...
/* Set Butcher tableau and associated parameters */
    ...
    //  - 1 = A-stable (but NON L-stable) SDIRK schemes
    //  + 0 = L-stable SDIRK
    //  + 1 = Gauss-Legendre
    //  + 2 = RadauIIA
    //  + 3 = Lobatto IIIC
    ...
    // };
void RKButcherData::SetData(IRKType RK_ID) {
    
    switch (RK_ID) {
        // 3-stage 4th-order A-stable SDIRK 
        case IRKType::ASDIRK4:
            /* ID: ASDIRK4 */
            s = 3;
            s_eff = 3;
            SizeData();
        ...
        default:
            mfem_error("RKButcherData:: Invalid Runge Kutta type.\n");
    }
}
