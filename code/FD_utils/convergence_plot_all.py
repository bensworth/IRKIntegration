...
'''
1D problems...
python convergence_plot_all.py -dir data/ -d 1 -FD 4 -g 0 -t 1 2 3 4 -dt_min 2 2 2 2 -dt_max 7 7 7 7
python convergence_plot_all.py -dir data/ -d 1 -FD 4 -g 1 -t 12 14 16 18 110 -dt_min 2 2 2 2 2 -dt_max 7 7 7 7 7
python convergence_plot_all.py -dir data/ -d 1 -FD 4 -g 2 -t 23 25 27 29 -dt_min 2 2 2 2 -dt_max 7 7 7 7 
python convergence_plot_all.py -dir data/ -d 1 -FD 4 -g 3 -t 32 34 36 38 -dt_min 2 2 2 2 -dt_max 7 7 7 7

2D problems...
python convergence_plot_all.py -dir data/ -d 2 -FD 4 -g 0 -t 1 2 3 4 -dt_min 2 2 2 2 -dt_max 6 6 6 6
python convergence_plot_all.py -dir data/ -d 2 -FD 4 -g 1 -t 12 14 16 18 110 -dt_min 2 2 2 2 2 -dt_max 6 6 6 5 5
python convergence_plot_all.py -dir data/ -d 2 -FD 4 -g 2 -t 23 25 27 29 -dt_min 2 2 2 2 -dt_max 6 6 5 5
python convergence_plot_all.py -dir data/ -d 2 -FD 4 -g 3 -t 32 34 36 38  -dt_min 2 2 2 2 -dt_max 6 6 6 5
'''
...
def filenametemp(scheme, t, dt_refine):
    return args["dir"] + "IRK" + t + "_dt" + str(dt_refine) + "_d" + args["d"] + "_FD" + args["FD"]
